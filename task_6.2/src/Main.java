...
public class Main {
    public static void main(String[] args) {
        try {
            FileInputStream fis = new FileInputStream("Z://project/edu_0759/task_6.2/ip.txt");
            int i;
            String proxy = "";
            while((i=fis.read()) != -1){
                if(i==13) continue;
    ...
    static class MyRunnableThread implements Runnable{
        ...
        public void run() {
            try {
                ...
                FileWriter writer = new FileWriter("Z://project/edu_0759/task_6.2/good_ip.txt", true);
